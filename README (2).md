...
**[👉 Jouer en ligne](https://ton-pseudo.github.io/undercover/)** ← remplace avec ton URL après déploiement
...
### Principe
- Un joueur parmi vous est **Undercover** : il reçoit un mot _proche_ mais _différent_ des autres.
...
### Déroulement
1. Entrez les noms des joueurs sur l'écran d'accueil.
2. Choisissez le mode (Classique ou Mr White).
3. Lancez la partie.
4. Chaque joueur prend le téléphone à son tour, appuie sur la carte pour voir son mot en secret, puis passe.
5. Une fois tous les mots révélés, débattez et votez pour éliminer l'Undercover !
...
1. Allez sur [github.com](https://github.com) et créez un nouveau dépôt nommé `undercover`.
2. Cochez **"Public"** (requis pour GitHub Pages gratuit).
...
4. Cliquez **Save**.
5. Attendez ~1 minute → votre jeu est en ligne sur :  
